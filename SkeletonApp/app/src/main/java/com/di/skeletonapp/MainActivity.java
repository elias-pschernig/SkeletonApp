        ...
        DetailFragment.OnFragmentInteractionListener
{
    ...
    @Override
    public void onButtonClicked(String param1, String param2) {
        //autoLaunchFragment(DetailFragment.newInstance(param1, param2));
        setFlow("detail", param1, param2);
    }
